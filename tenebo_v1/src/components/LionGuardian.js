...
function LionGuardian () {
  ...
  const [ , updateFetchedAdd ] = useState(false)
  const [ , setlistItems ] = useState("000")
    ...
    <div className='bg-neutral-50'>
      ...
      <div className="overflow-x-auto relative p-2">
        <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
          ...
          <tbody>
            {guardiansD.map((lionGuardian, index) => (
              <tr className="bg-white border-b text-gray-900 white:text-dark" key={index}>
